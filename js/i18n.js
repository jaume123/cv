...
const I18N = {
  es: {
    ...
    'exp.1.desc': 'Prácticas profesionales en empresa multinacional referente mundial en sistemas de audio profesional. Participación en el desarrollo de un <strong>portal web empresarial interno</strong> con stack moderno (Angular, React, TypeScript, Bootstrap) en un entorno corporativo real.',
    ...
    'proj.1.desc': 'Sitio web corporativo en producción para negocio familiar de alquiler de villas en Ibiza. Desarrollo end-to-end y despliegue. Sitio activo recibiendo tráfico real y reservas.',
    'proj.1.cta': 'Ver web en vivo →',
    'proj.2.t': 'Aplicación de Escritorio NFC',
    'proj.2.role': 'Electron + integración hardware NFC',
    'proj.2.desc': 'Aplicación de escritorio multiplataforma desarrollada con Electron, integrada con tecnología NFC para lectura/escritura de tarjetas. Demuestra integración con hardware desde JavaScript.',
    'proj.2.cta': 'Ver en GitHub →',
    'proj.3.t': 'Portal Web Empresarial',
    'proj.3.role': 'Práctica DAS Audio · Repo privado',
    'proj.3.desc': 'Portal web interno corporativo desarrollado durante mis prácticas. Stack moderno con Angular y React en frontend, TypeScript en todo el proyecto, Bootstrap para UI consistente, y arquitectura cliente-servidor con backend.',
  ...
  en: {
    ...
    'exp.1.desc': "Professional internship at a world-leading multinational in professional audio systems. Contributing to the development of an <strong>internal enterprise web portal</strong> with a modern stack (Angular, React, TypeScript, Bootstrap) in a real corporate environment.",
    ...
    'proj.1.desc': 'Live corporate website for a family villa rental business in Ibiza. End-to-end development and deployment. Active site receiving real traffic and bookings.',
    'proj.1.cta': 'View live site →',
    'proj.2.t': 'NFC Desktop Application',
    'proj.2.role': 'Electron + NFC hardware integration',
    'proj.2.desc': 'Cross-platform desktop application built with Electron, integrated with NFC technology for card read/write operations. Demonstrates hardware integration from JavaScript.',
    'proj.2.cta': 'View on GitHub →',
    'proj.3.t': 'Enterprise Web Portal',
    'proj.3.role': 'DAS Audio internship · Private repo',
    'proj.3.desc': 'Internal corporate web portal developed during my internship. Modern stack with Angular and React on frontend, TypeScript across the project, Bootstrap for consistent UI, and client-server architecture with backend.',
  ...
  pl: {
    ...
    'exp.1.desc': 'Praktyki zawodowe w międzynarodowej firmie, światowym liderze profesjonalnych systemów audio. Współudział w rozwoju <strong>wewnętrznego firmowego portalu webowego</strong> z nowoczesnym stackiem (Angular, React, TypeScript, Bootstrap) w realnym środowisku korporacyjnym.',
    ...
    'proj.1.desc': 'Działająca strona korporacyjna firmy rodzinnej zajmującej się wynajmem willi na Ibizie. Pełen rozwój i wdrożenie. Aktywna strona generująca prawdziwy ruch i rezerwacje.',
    'proj.1.cta': 'Zobacz na żywo →',
    'proj.2.t': 'Aplikacja Desktop z NFC',
    'proj.2.role': 'Electron + integracja sprzętu NFC',
    'proj.2.desc': 'Wieloplatformowa aplikacja desktopowa zbudowana z użyciem Electron, zintegrowana z technologią NFC do odczytu/zapisu kart. Pokazuje integrację sprzętu z poziomu JavaScript.',
    'proj.2.cta': 'Zobacz na GitHub →',
    'proj.3.t': 'Korporacyjny Portal Web',
    'proj.3.role': 'Praktyki DAS Audio · Prywatne repo',
    'proj.3.desc': 'Wewnętrzny korporacyjny portal webowy rozwijany podczas praktyk. Nowoczesny stack: Angular i React na froncie, TypeScript w całym projekcie, Bootstrap dla spójnego UI oraz architektura klient-serwer z backendem.',
